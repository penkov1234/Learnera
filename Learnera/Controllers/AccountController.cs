...
<<<<<<< HEAD
        ...
        public ActionResult AddUserToRole(UserRoleDTO model)
        {
            ...
            var roleToRemove = userRoles.First();
...
=======
>>>>>>> 57a67999857c356c56050b80f21d99a06616b814
        //
        // GET: /Account/Login
        [AllowAnonymous]
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                var userTmp = db.Users.Where(u => u.Id == userid).FirstOrDefault();
                
                foreach (_SubjectsViewModel subject in model.subjects)
                {
                    var bule = db.subjects.Where(s => s.Name == subject.Name && s.Professor == subject.Professor).FirstOrDefault();
                    if (bule != null)
                    {
                        userTmp.Subjects.Add(bule);
                    }
                }
                db.SaveChanges();
